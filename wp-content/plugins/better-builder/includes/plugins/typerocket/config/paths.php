...
return [
    ...
    */
    'urls' => [
        'assets' => plugins_url( '/', BETTERBUILDER_PLUGIN_FILE ) . '/includes/plugins/typerocket/wordpress/assets',
        'components' => plugins_url( '/', BETTERBUILDER_PLUGIN_FILE ) . '/includes/plugins/typerocket/wordpress/assets/components',
    ],
