( function( $, window ) {
	...
	var ee = { 
		...
		ScrollIndicatorBullets : function( $scope, $ ) {
			...
			if ( undefined !== typeof elementSettings.bullets_scroll_offset ) {
				scrollIndicatorArgs.scrollOffset = elementSettings.bullets_scroll_offset.size;
			}
			...
			var swiper = null,
				settings = {
					...
					element : {
						...
						arrowPrev 						: '.ee-swiper__button--prev-' + scopeId,
						arrowNext 						: '.ee-swiper__button--next-' + scopeId,
		...
		GallerySlider : function( $scope, $ ) {
			...
			var swiperSlider = null,
				...
				sliderSettings = {
					...
					element : {
						...
						autoplaySpeed 			: 'yes' === elementSettings.autoplay ? elementSettings.autoplay_speed.size : false,
						disableOnInteraction 	: '' !== elementSettings.autoplay_disable_on_interaction,
						stopOnHover 			: 'yes' === elementSettings.pause_on_hover,
						loop 					: 'yes' === elementSettings.infinite,
						arrows 					: '' !== elementSettings.show_arrows,
						arrowPrev 				: '.ee-swiper__button--prev-slider-' + scopeId,
						arrowNext 				: '.ee-swiper__button--next-slider-' + scopeId,
						effect 					: elementSettings.effect,
						speed 					: elementSettings.speed.size || 500,
						resistance 				: elementSettings.resistance.size || 0.25,
					},
					default : {
						effect 			: 'slide',
			...
			if ( hasCarousel ) {
				var carouselSettings = {
						...
						element : {
							...
							arrows 				: '' !== elementSettings.carousel_arrows,
							arrowPrev 			: '.ee-swiper__button--prev-carousel-' + scopeId,
							arrowNext 			: '.ee-swiper__button--next-carousel-' + scopeId,
							autoHeight 			: false,
							speed 				: elementSettings.carousel_speed.size || 500,
							slidesPerView 		: elementSettings.carousel_slides_per_view_mobile,
							slidesPerColumn 	: 'vertical' === elementSettings.carousel_orientation ? 1 : elementSettings.carousel_slides_per_column_mobile,
							slidesPerGroup 		: elementSettings.carousel_slides_to_scroll_mobile,
							resistance 			: elementSettings.carousel_resistance.size || 0.15,
							spaceBetween 		: elementSettings.carousel_spacing_mobile.size || 0,
							breakpoints 		: {
								tablet : {
									slidesPerView 	: elementSettings.carousel_slides_per_view_tablet,
									slidesPerColumn : 'vertical' === elementSettings.carousel_orientation ? 1 : elementSettings.carousel_slides_per_column_tablet,
									slidesPerGroup 	: elementSettings.carousel_slides_to_scroll_tablet,
									spaceBetween 	: elementSettings.carousel_spacing_tablet.size || 0,
								},
								desktop : {
									slidesPerView 	: elementSettings.carousel_slides_per_view,
									slidesPerColumn : 'vertical' === elementSettings.carousel_orientation ? 1 : elementSettings.carousel_slides_per_column,
									slidesPerGroup 	: elementSettings.carousel_slides_to_scroll,
									spaceBetween 	: elementSettings.carousel_spacing.size || 0,
								},
							},
						},
						default : {
			...
			ee.GallerySlider.destroy = function() {
				if ( swiperSlider ) {
		...
		Carousel : function( $swiper, settings ) {
			...
			ee.Carousel.init = function() {
				...
				if ( settings.element.arrows ) {
					...
					var $prevButton = $( settings.element.arrowPrev ),
						$nextButton = $( settings.element.arrowNext );

					if ( $prevButton.length && $nextButton.length ) {
						swiperArgs.navigation.prevEl = settings.element.arrowPrev;
						swiperArgs.navigation.nextEl = settings.element.arrowNext;
					}
				}
