	...
	private function render_preview_items() {
		...
		foreach ( $gallery as $index => $item ) {
			...
			if ( $link ) {
				...
				$this->add_lightbox_data_attributes( $media_key, $item['id'], $settings['open_lightbox'], $this->get_id() );
		...
		$this->add_render_attribute( [
			$prev_key => [
				'class' => [
					...
					'ee-arrow',
					'ee-arrow--prev',
					'ee-swiper__button--prev-' . $key . '-' . $this->get_id(),
				],
			],
			$prev_icon_key => [
			...
			$next_key => [
				'class' => [
					...
					'ee-arrow',
					'ee-arrow--next',
					'ee-swiper__button--next-' . $key . '-' . $this->get_id(),
				],
			],
			$next_icon_key => [
