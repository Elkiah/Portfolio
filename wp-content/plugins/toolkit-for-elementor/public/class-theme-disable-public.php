...
if( ! class_exists('Theme_Disable_Public') ) {
    ...
    class Theme_Disable_Public{
        ...
        public function enqueue_styles(){
            wp_enqueue_style('theme-disable-public', TOOLKIT_FOR_ELEMENTOR_URL . 'public/css/normalize.css', array(), '8.0.1', 'all');
        }
        ...
        function wp_head(){
            ...
            if( $post->post_type != 'toolkit_template' && $header_code ){
                eval(' ?>'.str_replace('\"','"', $header_code).'<?php ');
            }
        }
        ...
        function wp_footer(){
            ...
            if( $post->post_type != 'toolkit_template' && $footer_code ){
                eval(' ?>'.str_replace('\"','"', $footer_code).'<?php ');
            }
        }
