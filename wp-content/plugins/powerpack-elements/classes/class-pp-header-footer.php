...
final class PP_Header_Footer {
	...
	static public function enqueue_scripts() {
		...
		wp_enqueue_script( 'pp-header-layout-script', POWERPACK_ELEMENTS_URL . 'assets/js/header-layout.js', [] );
	 ...
	 * @return void
	 */
	static public function render_header( $tag = null, $id = '' ) {
		$tag 		= ! $tag ? 'header' : $tag;
		$id 		= ! $id ? 'masthead' : $id;
		$header_id 	= self::$header;
		...
		?>
		<<?php echo $tag; ?> <?php if ( $id) { echo 'id="'.$id.'"'; } ?> class="pp-elementor-header" itemscope="itemscope" itemtype="https://schema.org/WPHeader" data-type="header" data-header-id="<?php echo $header_id; ?>" data-sticky="<?php echo $data_sticky; ?>" data-shrink="<?php echo $data_shrink; ?>" data-overlay="<?php echo $data_overlay; ?>" data-overlay-bg="<?php echo $overlay_bg; ?>">
