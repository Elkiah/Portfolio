		...
		<div <?php echo $this->get_render_attribute_string( 'container' ); ?>>
			...
			<div class="pp-advanced-tabs-content-wrapper pp-tabs-panels <?php echo $settings['type']; ?>-content">
				<?php foreach ( $tabs as $index => $item ) :
					...
					<div class="pp-advanced-tabs-title pp-tabs-label pp-tab-responsive <?php echo $defaultContent . $hover_class;?>" data-index ="<?php echo $id_int . $tab_count;?>">
