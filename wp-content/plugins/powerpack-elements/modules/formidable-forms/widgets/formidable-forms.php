    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'type'              => Controls_Manager::COLOR,
                'selectors'         => [
                    '{{WRAPPER}} .pp-formidable-forms .form-field label, {{WRAPPER}} .pp-formidable-forms .vertical_radio .frm_primary_label' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'             => __( 'Typography', 'powerpack' ),
                'scheme'            => Scheme_Typography::TYPOGRAPHY_4,
                'selector'          => '{{WRAPPER}} .pp-formidable-forms .form-field label, {{WRAPPER}} .pp-formidable-forms .vertical_radio .frm_primary_label',
            ]
        );
